...
VistaUsuario.prototype = {
  ...
  reconstruirGrafico: function(){
    ...
    preguntas.forEach(function(clave){
      ...
      self.dibujarGrafico(clave.textoPregunta, listaParaGrafico);
    })
  },
  ...
  reconstruirLista: function() {
    ...
    preguntas.forEach(function(clave){
      ...
      var div = $('<div>');
      div.attr('value', clave.textoPregunta);
      div.attr('id', clave.id);
      div.html(clave.textoPregunta);
      listaPreguntas.append(div);
      var respuestas = clave.cantidadPorRespuesta;
      self.mostrarRespuestas(listaPreguntas, respuestas, clave);
    })
  },
  ...
  agregarVotos: function(){
    ...
    $('#preguntas').find('div').each(function() {
      ...
      var id = $(this).attr('id')
      var pregunta = self.modelo.obtenerPregunta(nombrePregunta);
      var respuestaSeleccionada = $('input[name=' + id + ']:checked').val();
      $('input[name=' + id + ']').prop('checked',false);
      $('#nombreUsuario').prop('value', '');
      self.controlador.agregarVoto(pregunta, respuestaSeleccionada);
    });
  },
  ...
  dibujarGrafico: function(nombre, respuestas){
    ...
    function drawChart() {
      ...
      var ubicacionGraficos = self.elementos.graficosDeTorta;
